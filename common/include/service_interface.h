...
#ifndef _HLV_SERVICE_INTERFACE_H_
#define _HLV_SERVICE_INTERFACE_H_
namespace hlv {
namespace service{
namespace server {

/// The interface all service providers must implement.  
class ServiceInterface {
  public:
    ...
    virtual bool AuthenticateToken (const int64_t requestID,
                                ...
                                hlv_service::ServiceResponse& response) = 0;
