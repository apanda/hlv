...
#ifndef _HLV_PROXY_SERVICE_H_
#define _HLV_PROXY_SERVICE_H_
namespace hlv {
namespace service {
namespace proxy {
...
// authenticate itself). 
class ProxyService : public hlv::service::server::ServiceInterface {
  public:
    ProxyService (AnycastGroupType groups,
